...
var Game = module.exports = function(options) {
  ...
  this.board   = {
    top    : 0
  , left   : 0
  , radius : (options && options.radius) || 100
  };
  this.board.center = new Vector(this.board.radius, this.board.radius);
  this.board.bottom = this.board.radius * 2;
  this.board.right  = this.board.radius * 2;
